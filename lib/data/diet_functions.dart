...
/* CONFIGURE THE DATABSE INSTANCE HERE*/
  ...
  */
  ...
  void addFoddItem(
    ...
    relevantMeal.food.add(
      Food(foodName: foodName, protein: protein, calorie: calorie)
    );
  ...
  Meals getRelevantMeal(String mealName) {
    Meals relevantMeal =
        mealsList.firstWhere((meal) => meal.name == mealName);
